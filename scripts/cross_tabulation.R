cross_tabulate_data <- function(dataset, field_var, level_var, cell_value_var) {
...
cross_tabulate <- function(wb, worksheet_name, dataset, field_var, level_var, cell_value_var, cell_format
    ...
    cross_tabulation <- cross_tabulate_data(dataset, field_var, level_var, cell_value_var)
...
addLevelIncomeSummary <- function(wb, worksheet_name, dataset, level_var, cell_value_var, start_row) {
    level_summary <- dataset %>% group_by_at(level_var) %>% 
        ...
        transpose(make.names=level_var) # this uses the data.table version
    print(level_summary)
