...
The age columns must be in sequnce for this to work, the index of the age columns are manually defined and will result in highly undesirable behavour if they move.
```{r}
age_cols <- 6:16
...
age_value_matrix <- annual_income_with_imputation %>% 
    select(-c(Total, missing_count, can_impute, age_15_19_impute_income)) %>% apply(1, function(row) {
