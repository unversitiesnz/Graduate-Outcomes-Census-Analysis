...
level_15_19_mean_incomes <- data %>% 
    filter(age == "15-19 years" & !is.na(mean_income) & !level_code %in% c('07', '08', '09', '10')) %>% 
...
higher_level_imputes <- tibble(employed_code = c(rep(1,4), rep(2,4), rep(3,4)), level_code = rep(c('07', '08', '09', '10'),3))
...
annual_income_with_imputation %>% 
    filter(safe_values == TRUE, field_code == '0909', level_code == '07')
```
