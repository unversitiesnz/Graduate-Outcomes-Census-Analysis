...
The main goal of this notebook is to create an excel workbook containing a couple of sheets used by the executive director (Chris) to answer ad-hoc queries.
