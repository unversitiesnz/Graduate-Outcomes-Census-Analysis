...
# Read input file
```{r}
grad_outcomes_datacube <- read.csv("../input_data/occupations_by_levels_narrow_2006.csv")
...
```{r}
field_of_study_totals <- read.csv("../input_data/field_counts_2006.csv") %>%
append_narrow_field_of_study_code(code_var = "narrow_field_code", field_var = "narrow_field_text") %>%
...
```{r}
occupation_totals <- read.csv("../input_data/occup_counts_2006.csv")
...
openxlsx::saveWorkbook(wb, '../working_outputs/Graduate ROI Occupation by Field of Study 2006.xlsx', overwrite = T)
```
