...
The objective of this notebook is to calculate the typical study level of individuals in different occupation.
...
excluding not disclosed and unkown qualification levels.
```{r}
