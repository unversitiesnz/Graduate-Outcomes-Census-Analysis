...
<<<<<<< HEAD
##Creating two large functions, one which gets mean incomes by qual level and field for age bracket, and other which tabulates and save the income set
=======

I am thinking about removing the merging of overseas with level 3.
>>>>>>> 1df48599f905108f9761f3f056334e0ad54ed8cb
```{r}
