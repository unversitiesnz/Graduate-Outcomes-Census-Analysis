...
QUESTION - Careers website does not have field of study for generic degrees, and its qual pages are provider specific. How do we get fees from these?
...
fee_component = fee*years
none_fee_component = 10,900*years
loan_for_course = sum
...
fees2 <- fees_and_durations2 %>% 
    mutate(
        ...
        #$10,900 ~ maximum living costs available per year as part of student loan - cf median of only $4,800?
    ) %>% mutate(
