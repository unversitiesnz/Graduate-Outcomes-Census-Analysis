...
damien_costs <- read_excel("../program_costs/Damien Fee and Duration Tables 2013.xlsx", 
                                                               range = "C3:I81", na = "n/a")
costs_long <- pivot_longer(damien_costs, cols = c('4':'10'), names_to = 'qualLevel', values_to = 'fee')
...
damien_durations <- read_excel("~/UNZ/Census work/Copy of Damien Fee and Duration Tables 2018_4_DW.xlsx", 
                                range = "J3:P81", na = "n/a")
durations_long <- pivot_longer(damien_durations, cols = c('4':'10'), names_to = 'qualLevel', values_to = 'duration_yr')
...
write.csv(full, "../datasets/level_nzsced_fees_updated.csv", row.names = FALSE)
...
fees2 = mutate(fees2, 
        ...
        none_fee_component = 5000 * duration_yr 
...
#Checking
filter(costs, field_code == '1007') %>% arrange(level_code) %>% View()
```
