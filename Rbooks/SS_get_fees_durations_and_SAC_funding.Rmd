...
level_nzsced_fees.loc[9, '0109'] #This seems wrong

checking_bio_masters = course_nzsced2[(course_nzsced2['qualLevel'] == 9) & (course_nzsced2['NZSCED_Narrow'] == '0109')]
course_nzsced2.columns

checking_bio_masters.loc[:, checking_bio_masters.columns != 'url']
checking_bio_masters[['NZSCED', 'NZSCED_Narrow', 'annualFee', 'duration', 'duration_yr', 'qualLevel']]
checking_bio_masters.shape
...
```
```{r}
filter(fees_and_durations, NZSCED_Narrow == '0109')
```
...
sac_paid %>% filter(level_code == '09', field_code == '1007') %>% head(8)
```
